...
layoutgb.addWidget(func_txt_w, 0, 0, 1, 3)
...
def process_data(message):
    global time_buffer, raw_acc_buffer, raw_grav_buffer, raw_quat_buffer, raw_ori_buffer, current_class
    ...
    x = np.expand_dims(np.hstack([raw_acc_buffer, raw_grav_buffer, raw_ori_buffer]), axis=0)
